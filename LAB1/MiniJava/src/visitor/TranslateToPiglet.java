...
public class TranslateToPiglet extends GJDepthFirst<MType, MType> {
	...
	String pigletCode;
	HashMap<String, String> currentFunctionUsedVarList = new HashMap<String, String>();
	...
	public MType visit(FormalParameter n, MType argu) {
		...
		if(paraIndex < 19) {
			...
			//参数大于18个，需要从内存中加载到临时变量TEMP20,21,……
			temp = "TEMP " + Integer.toString(paraIndex + 1);
	...
	public MType visit(AllocationExpression n, MType argu) {
		...
		String vTableSize = Integer.toString(4 * (varList.size() + 1));
		String dTableSize = Integer.toString(4 * methodList.size());
	...
	public MType visit(ExpressionRest n, MType argu) {
		...
		if(expressionIndex <= 18) {
			...
			if(expressionIndex == 19) {
				...
				String remainArguNum = Integer.toString(4 * (method.getParamNum() - 18));
			...
			n.f1.accept(this, argu);// expression
			pigletCode += "\n";
			if(method.getParamNum() == expressionIndex) {
